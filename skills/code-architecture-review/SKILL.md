...
description: "Conduct a comprehensive code and architecture review of any repository using graph-based structural analysis (Graphify/AST) and produce a detailed, actionable improvement plan. Compatible with Claude Code, Antigravity (agy), Cursor, and general AI agents."
---
