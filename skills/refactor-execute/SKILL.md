...
description: "Safely execute architectural refactorings and code improvements step-by-step from an improvement plan or task list. Enforces green baseline tests, atomic commits, behavioral invariance, and incremental verification."
---
