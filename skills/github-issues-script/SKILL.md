...
description: "Convert a list of findings, review items, architectural gaps, or bug reports into a structured, reviewable batch script (using gh issue create) that generates high-quality GitHub issues with exact file coordinates, impact analysis, recommended remediations, and proper labels."
---
...
1. An existing improvement plan (e.g. `docs/ARCHITECTURE_REVIEW.md`, `.planning/reviews/`, `TODO.md`)
