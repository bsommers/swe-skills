...
description: "Audit third-party package dependencies across JS/TS, Python, Rust, Go, Java, and Ruby for known security vulnerabilities (CVEs), outdated packages, license compliance risks, and supply chain threats with actionable remediation plans."
---
