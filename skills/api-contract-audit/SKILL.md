...
description: "Audit API contracts, OpenAPI/Swagger specifications, GraphQL schemas, Protobufs, and DTOs against backend route implementations to detect schema drift, undocumented endpoints, type mismatches, and breaking contract changes."
---
